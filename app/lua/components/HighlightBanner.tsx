...
const HighlightBanner: React.FC<HighlightBannerProps> = ({ info, onClick }) => (
  <div className="mb-4 flex justify-center">
    <button
      type="button"
      onClick={onClick}
      className="flex max-w-full flex-wrap items-center justify-center gap-2 rounded-2xl border border-sky-300/30 bg-slate-900/80 px-3 py-2 text-[11px] text-slate-100 shadow-lg shadow-sky-900/40 backdrop-blur focus:outline-none focus:ring-2 focus:ring-sky-300/60 sm:rounded-full sm:px-4 sm:py-3 sm:text-[12px]"
    >
