...
const EclipseSummaryCard = ({
  lastSyncLabel,
  onOpenSidePlanet,
  onSync,
  bestPhase,
  onOpenSidePlanetFromBadge,
}: EclipseSummaryCardProps) => (
...
const PhaseBarsCard = ({ phaseStats, maxTotal, bestPhase, hasPhaseData }: PhaseBarsCardProps) => (
