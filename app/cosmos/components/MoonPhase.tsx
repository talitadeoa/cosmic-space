...
export const MoonPhase: React.FC<MoonPhaseProps> = ({
  ...
  const renderMoonPhase = () => {
    ...
    switch (phase) {
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 24px rgba(148,163,184,0.3), inset -2px -2px 8px rgba(0,0,0,0.5)',
            }}
          />
        );
          ...
          <div className={baseClasses}>
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 24px rgba(148,163,184,0.6), inset -1px -1px 6px rgba(0,0,0,0.4)',
              }}
            />
          </div>
        );
          ...
          <div className="relative w-full h-full rounded-full overflow-hidden">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 24px rgba(148,163,184,0.7), inset -2px -2px 8px rgba(0,0,0,0.5)',
              }}
            />
          </div>
        );
          ...
          <div className={baseClasses}>
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 24px rgba(148,163,184,0.8), inset -1px -1px 6px rgba(0,0,0,0.2)',
              }}
            />
          </div>
        );
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 24px rgba(148,163,184,0.9), inset -1px -1px 4px rgba(0,0,0,0.2)',
            }}
          />
        );
      ...
      default:
        return <div className={`${baseClasses} shadow-[0_0_24px_rgba(148,163,184,0.9)]`} />;
    }
  };
