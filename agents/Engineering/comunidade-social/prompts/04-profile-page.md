# Prompt 04: Página de Perfil Público

## Objetivo
Criar a página de perfil público de usuários.

## Contexto
- API criada em `app/api/community/profile/[userId]/route.ts`
- Componentes em `app/comunidade/components/profile/`
- Layout base em `components/layouts/SpacePageLayout.tsx`

## Instrução

Crie o arquivo `app/comunidade/perfil/[userId]/page.tsx`:
...
export default function ProfilePage() {
  ...
  if (loadingState === 'not-found') {
    return (
      <SpacePageLayout title="Perfil não encontrado">
  ...
  return (
    <SpacePageLayout title={profile.displayName}>
      <div className="space-y-6">
...
- [ ] Estado 404 amigável
- [ ] FollowButton aparece para outros usuários
- [ ] Botão "Editar perfil" para próprio perfil
- [ ] Stats clicáveis (seguidores/seguindo)
