...
const ringOutline = 'pointer-events-none absolute inset-0 rounded-full ring-1 ring-white/10';
...
export function drawSun(
  ...
  ctx.arc(
    centerX - radius * 0.12,
    centerY - radius * 0.12,
    radius * SUN_RADIUS_MULTIPLIERS.highlightRadius,
    0,
    Math.PI * 2
  );
  ctx.fill();
...
const SUN_RAY_LAYER_CONFIGS = [
  {
    ...
    gradient:
      'bg-[conic-gradient(from_8deg,rgba(255,237,213,0)_0deg,rgba(254,210,100,0.3)_14deg,rgba(253,180,90,0)_24deg,rgba(255,250,220,0.38)_36deg,rgba(253,170,31,0)_50deg,rgba(255,240,200,0.28)_64deg,rgba(253,180,90,0)_78deg,rgba(255,250,220,0.3)_94deg,rgba(255,237,213,0)_100deg)]',
  },
  {
    blur: 'blur-[9px]',
    opacity: 'opacity-50',
    ...
    gradient:
      'bg-[conic-gradient(from_120deg,rgba(255,255,255,0)_0deg,rgba(254,210,100,0.2)_18deg,rgba(255,255,255,0)_36deg,rgba(253,170,31,0.25)_52deg,rgba(255,255,255,0)_70deg,rgba(254,210,100,0.2)_86deg,rgba(255,255,255,0)_100deg)]',
  },
] as const;
...
const CELESTIAL_STYLES: Record<CelestialType, string> = {
  ...
  luaGibosaCrescente:
    "bg-[radial-gradient(circle_at_45%_50%,#0f172a_20%,#111827_50%,#0b1220_75%,#030712_100%)] shadow-[0_0_24px_rgba(148,163,184,0.65)] before:absolute before:-inset-[18%] before:rounded-full before:content-[''] before:bg-[radial-gradient(circle_at_75%_50%,rgba(226,232,240,0.98)_0%,rgba(203,213,225,0.90)_12%,rgba(148,163,184,0.65)_28%,rgba(100,116,139,0.15)_45%,rgba(15,23,42,0)_65%)] before:opacity-95 after:absolute after:-inset-[14%] after:rounded-full after:content-[''] after:bg-[radial-gradient(circle_at_30%_50%,rgba(15,23,42,0.45)_0%,rgba(15,23,42,0)_55%)] after:mix-blend-soft-light after:opacity-70",
  luaCheia:
  ...
  luaGibosaMinguante:
    "bg-[radial-gradient(circle_at_55%_50%,#0f172a_20%,#111827_50%,#0b1220_75%,#030712_100%)] shadow-[0_0_24px_rgba(148,163,184,0.65)] before:absolute before:-inset-[18%] before:rounded-full before:content-[''] before:bg-[radial-gradient(circle_at_25%_50%,rgba(226,232,240,0.98)_0%,rgba(203,213,225,0.90)_12%,rgba(148,163,184,0.65)_28%,rgba(100,116,139,0.15)_45%,rgba(15,23,42,0)_65%)] before:opacity-95 after:absolute after:-inset-[14%] after:rounded-full after:content-[''] after:bg-[radial-gradient(circle_at_70%_50%,rgba(15,23,42,0.45)_0%,rgba(15,23,42,0)_55%)] after:mix-blend-soft-light after:opacity-70",
  luaMinguante:
  ...
  anel: 'bg-gradient-to-br from-slate-200/90 via-slate-300/90 to-slate-50/70 ring-2 ring-sky-200/60 shadow-[0_0_22px_rgba(186,230,253,0.75)]',
  eclipse:
...
const buildMotionConfig = (
  pulseOnMount: boolean,
  floatOffset: number,
  breathing: boolean = false
) => {
  const floatKeyframes = breathing
    ? [floatOffset - 8, floatOffset + 8]
    : [floatOffset - 6, floatOffset + 6];
