        ...
        >
          ...
          >
            ...
            <div className="mb-6 text-center">
              <h2 className="mb-2 text-2xl font-bold text-sky-300">{phaseInfo.name}</h2>
              <p className="mb-1 text-sm text-sky-200">{phaseInfo.quarter}</p>
              <p className="text-xs text-sky-400">{phaseInfo.months}</p>
            </div>
